...
estimateB<-function(locus){
  ...
  # regress PRSEstimates on genotypes
  prsRegression<-lm(individualPRSEstimates[healthy] ~ individualGenotypes[locus, healthy])
  summary(prsRegression)$coefficients[2, "Estimate"]
